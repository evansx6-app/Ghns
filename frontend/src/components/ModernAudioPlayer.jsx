            ...
            <div className="space-y-6">
              ...
              >
                <CardContent className="p-4 md:p-6 lg:p-8">
                  ...
                  <div className="flex flex-col lg:flex-row items-start lg:items-stretch gap-3 lg:gap-16">
                    ...
                    <div className="w-full lg:w-[50%] flex justify-center lg:justify-start order-2 lg:order-1">
                      <div className="relative w-full max-w-md lg:max-w-2xl px-4 lg:pl-2 lg:pr-0">
                        {/* Screen bezel/frame */}
                        <div 
                    ...
                    <div className="w-full lg:w-[50%] flex flex-col items-center lg:items-start gap-4 lg:gap-6 order-3 lg:order-2 lg:justify-center lg:pr-4">
                      ...
                      {/* Level Meters */}
                      <div className="w-full max-w-md lg:max-w-full px-4 lg:px-0 lg:my-1">
                        <SafariVisualiser 
                          audioRef={audioRef}
                          isPlaying={isPlaying}
                          colors={colors}
                      ...
                      {/* Play/Pause Button */}
                      <div className="w-full max-w-md lg:max-w-full px-4 lg:px-0 lg:my-2">
